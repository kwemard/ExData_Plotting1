...
plot(DATE,household_sub$Global_active_power,type="l",ylab="Global Active Power",xlab="")

plot(DATE,household_sub$Voltage,xlab="datetime",ylab="Voltage",type="l")
...
plot(DATE,household_sub$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l")
